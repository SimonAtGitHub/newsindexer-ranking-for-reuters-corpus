...
public class DateRuleTest extends TFRuleBaseTest {
	...
	public void testRule() {
		...
		try {
			...
			assertArrayEquals(new String[] { "President", "Franklin", "D.",
					"Roosevelt", "to", "proclaim", "19411207,", "'a", "date",
					...
					runTest(TokenFilterType.DATE,
							"President Franklin D. Roosevelt "
									...
									+ "live in infamy'"));
			assertArrayEquals(new String[] { "The", "Academy", "operated",
					"until", "it", "was", "destroyed", "by", "Lucius",
					"Cornelius", "Sulla", "in", "-00840101" },
					runTest(TokenFilterType.DATE, "The Academy operated until "
							+ "it was destroyed by Lucius "
							+ "Cornelius Sulla in 84 BC"));
			assertArrayEquals(new String[] { "For", "instance,", "the",
					"19480101", "ABL", "finalist", "Baltimore", "Bullets",
					"moved", "to", "the", "BAA", "and", "won", "that",
					"league's", "19480101", "title." },
			...
			assertArrayEquals(new String[] { "It", "was", "now", "about",
					"10:15:00." },
					runTest(TokenFilterType.DATE, "It was now about 10:15 am."));
			assertArrayEquals(new String[] { "Godse", "approached", "Gandhi",
					"on", "19480130", "during", "the", "evening", "prayer",
					"at", "17:15:00." }, runTest(TokenFilterType.DATE,
					"Godse approached Gandhi on "
							+ "January 30, 1948 during the "
							+ "evening prayer at 5:15PM."));
			assertArrayEquals(
					new String[] { "Pune", "is", "known", "to", "have",
							"existed", "as", "a", "town", "since", "08470101." },
					runTest(TokenFilterType.DATE,
							"Pune is known to have existed as a town since 847AD."));
			assertArrayEquals(new String[] { "19000411", "is", "the", "101st",
					"day", "of", "the", "year", "(102nd", "in", "leap",
					"years)", "in", "the", "Gregorian", "calendar." },
					runTest(TokenFilterType.DATE, "April 11 is the 101st day "
							+ "of the year (102nd in "
							+ "leap years) in the Gregorian " + "calendar."));
			assertArrayEquals(new String[] { "Apple", "is", "one", "of", "the",
					"world's", "most", "valuable", "publicly", "traded",
					"companies", "in", "20110101-20120101." },
